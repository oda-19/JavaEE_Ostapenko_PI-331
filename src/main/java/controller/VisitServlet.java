...
public class VisitServlet extends HttpServlet {
	...
	String userPath;
	public VisitServlet() throws FileNotFoundException, IOException {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if("/visit".equals(userPath)){
			request.getRequestDispatcher("/WEB-INF/view/visit.jsp")
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try (Connection conn = builder.getConnection()){
			...
			try (PreparedStatement preparedStatement =
						 conn.prepareStatement(INSERT_VISIT)){
			...
			System.out.println(e);
			getServletContext().getRequestDispatcher("/WEB-INF/view/visit.jsp")
					.forward(request, response);
		}
