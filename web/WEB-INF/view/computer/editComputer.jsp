...
<div class="container-fluid">
    ...
    <h3>Редактирование компьютера</h3>
    <div class="container" id="container-form">
        <form method="POST" action="">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="computerName" class="form-control" id="staticComputerName"
                     value="${computerEdit[0].getComputerName()}" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="computerDescription" class="form-control" id="staticComputerDescription"
                     value="${computerEdit[0].getComputerDescription()}" />
                </div>
            </div>
