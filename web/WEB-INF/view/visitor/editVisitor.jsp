...
<div class="container-fluid">
    ...
    <h3>Редактирование посетителя</h3>
    <div class="container" id="container-form">
        <form method="POST" action="">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="surname" id="staticSurname"
                           value="${visitorEdit[0].getSurname()}" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" id="staticName"
                           value="${visitorEdit[0].getName()}" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="patronymic" id="staticPatronymic"
                           value="${visitorEdit[0].getPatronymic()}" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="identityDocument" id="staticIdentityDocument"
                           value="${visitorEdit[0].getIdentityDocument()}" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="address" id="staticAddress"
                           value="${visitorEdit[0].getAddress()}" />
                </div>
            </div>
